  ...
  return (
    <div className="min-h-screen bg-background font-body text-on-background">
      ...
      <div className="flex min-h-screen flex-col">
        {/* Top bar */}
        <header
          className="sticky top-0 z-40 border-b border-gray-100 dark:border-[hsl(30_6%_26%)] bg-white/95 dark:bg-[hsl(30_4%_9%)]/95 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/85 dark:supports-[backdrop-filter]:bg-[hsl(30_4%_9%)]/85"
        >
                  ...
                  return (
                    <a
                      ...
                      className={`inline-flex h-9 shrink-0 items-center gap-2 rounded-lg px-3 text-sm font-medium transition-colors ${
                        active
                          ? 'bg-[#e8392a] text-white shadow-sm'
                          : 'text-slate-500 dark:text-[hsl(35_8%_55%)] hover:bg-slate-50 dark:hover:bg-[hsl(30_4%_16%)] hover:text-slate-900 dark:hover:text-foreground'
                      }`}
                    >
              ...
              {toggleTheme && (
                <button
                  ...
                  className={`grid h-9 w-9 place-items-center rounded-lg transition-all active:scale-95 ${
                    theme === 'light'
                      ? 'bg-[#e8392a] text-white shadow-sm hover:bg-[#d42e20]'
                      : 'border border-[hsl(30_6%_26%)] bg-[hsl(30_4%_14%)] text-[hsl(35_8%_62%)] hover:bg-[hsl(30_4%_18%)]'
                  }`}
              ...
              {user ? (
                <>
                  <button
                    type="button"
                    onClick={openProfile}
                    className="grid h-9 w-9 place-items-center rounded-lg bg-[#e8392a] text-white shadow-sm transition-all hover:bg-[#d42e20] active:scale-95"
                    title="โปรไฟล์"
                    aria-label="โปรไฟล์"
                  >
                    ...
                    <a
                      ...
                      className={`flex h-14 min-w-[72px] flex-1 shrink-0 snap-start flex-col items-center justify-center gap-1 rounded-xl text-[11px] font-semibold transition-colors ${
                        active
                          ...
                          : 'text-muted-foreground hover:bg-slate-50 dark:hover:bg-[hsl(30_4%_16%)] hover:text-foreground'
                      }`}
                    >
                      <NavIcon icon={item.icon} active={active} />
