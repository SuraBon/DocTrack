    ...
    <Dialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
      <DialogContent className="w-[calc(100vw-1rem)] max-w-lg md:max-w-4xl max-h-[92vh] overflow-hidden rounded-2xl border border-slate-200 bg-white p-0 shadow-xl">
        <div className="flex max-h-[92vh] flex-col">
          {/* Header */}
          <div className="bg-gradient-to-r from-slate-900 to-slate-800 px-5 py-5 text-white sm:px-6">
          ...
          <div className="modal-scroll flex-1 overflow-y-auto bg-slate-50 p-4 sm:p-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch">
              ...
              <div className="space-y-3">
                ...
                {/* Parcel Details */}
                <div className="flex items-start gap-3 rounded-2xl bg-white border border-slate-200 shadow-sm px-4 py-4">
                ...
                {/* Note */}
                <div className={`flex items-start gap-3 rounded-2xl border shadow-sm px-4 py-4 ${formData.note ? 'bg-amber-50 border-amber-200' : 'bg-white border-slate-200'}`}>
                ...
                {/* GPS Status */}
                <div className={`flex items-center gap-3 rounded-2xl border shadow-sm px-4 py-3.5 ${position ? 'bg-emerald-50 border-emerald-200 text-emerald-800' : 'bg-white border-slate-200 text-slate-500'}`}>
              ...
              <div className="h-full">
                <div className={`overflow-hidden rounded-2xl border shadow-sm flex flex-col h-full ${proofPhotoPreview ? 'border-blue-200 bg-white' : 'border-slate-200 bg-white'}`}>
                  <div className={`flex items-center gap-3 px-4 py-3.5 shrink-0 ${proofPhotoPreview ? 'bg-blue-50 border-b border-blue-100' : 'bg-slate-50 border-b border-slate-200'}`}>
                    <div className={`flex size-9 shrink-0 items-center justify-center rounded-xl ${proofPhotoPreview ? 'bg-blue-100' : 'bg-slate-200'}`}>
                  ...
                  {proofPhotoPreview ? (
                    <div className="bg-white p-2 flex-1 flex items-center justify-center min-h-[250px] md:min-h-0">
                      <img
                    ...
                    <div className="bg-white p-8 flex-1 flex flex-col items-center justify-center text-slate-300 min-h-[250px]">
